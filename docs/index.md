...
<div style="display:flex; gap:20px; align-items:center; flex-wrap:wrap; margin-bottom:2rem; padding:1.5rem; background:#f8f9fa; border-radius:8px;">
  ...
  <div>
    ...
    <p style="margin:.5rem 0; line-height:1.6;"> I’m Javier, a SOC Analyst and creative thinker blending a design background with a passion for defending enterprise environments. I build hands-on labs, fine-tune detections, and create repeatable playbooks that keep blue-team operations sharp and effective. </p>
  </div>
</div>
