...
/* Assuming htp_config_set_number_headers_limit function in bundled libhtp */
#define HAVE_HTP_CONFIG_SET_HEADERS_LIMIT 1
...
#define PACKAGE_STRING "suricata 7.0.12"
...
/* Git revision */
#define REVISION f305213aa 2025-09-15
