...
| **Ticketing Platform** | Jira, ServiceNow, RTIR     | Manage and track incidents                                             | Create, assign, and update tickets for incidents, ensuring proper documentation and resolution tracking |
...
> **Note:** Replace placeholder descriptions with actual SOC environment screenshots.

| Tool | Screenshot | Explanation |
|------|------------|-------------|
| **Splunk Dashboard** | ![splunk_screenshot](path/to/splunk.png) | Displays real-time alerts, log queries, and event correlation |
| **ServiceNow Ticket** | ![servicenow_screenshot](path/to/servicenow.png) | Shows incident ticket details, workflow, and resolution notes |
| **Zabbix Monitoring** | ![zabbix_screenshot](path/to/zabbix.png) | Graphs and alerts for infrastructure health and uptime |
